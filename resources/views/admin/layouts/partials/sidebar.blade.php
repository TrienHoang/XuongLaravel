            ...
            <div class="sidebar-wrapper">
                ...
                <div>
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo main-white" src="{{asset('build/assets/images/logo/logo.png')}}" alt="logo">
                            <img class="img-fluid main-logo main-dark" src="{{asset('build/assets/images/logo/logo-white.png')}}"
                                alt="logo">
                        </a>
                    </div>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{ route('admin.products.listProduct') }}">Prodcts</a>
                                        </li>

                                        <li>
                                            <a href="{{ route('admin.products.addProduct') }}">Add New Products</a>
                                        </li>
                                    </ul>
                                </li>
